...
var RouteDestination = (function () {
    function RouteDestination(loadChildrenPath, sourceResourcePath, query) {
        ...
        var _b = Object.assign({}, options_1.DEFAULT_RESOURCE_OPTIONS, loaderUtils.getOptions({ query: pathQuery ? '?' + pathQuery : '?' })), loader = _b.loader, chunkName = _b.chunkName, bySymbol = _b.bySymbol;
        this.options = {
